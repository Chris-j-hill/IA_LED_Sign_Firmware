...
#define APPLY_THREE_BIT_CHECKSUM_SUPPRESSION(a)   (a & 0b11110001)
#define APPLY_FRAME_NUM_PARITY_CHECKING_MASK(a)   ((a>>4)& 0b00001111)
#define APPLY_THIS_FRAME_PARITY_CHECKING_MASK(a)  (a & 0b00001111)
